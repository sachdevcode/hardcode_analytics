...
router.get('/', async (req: Request, res: Response): Promise<void> => {
  ...
  const minSubscribers = req.query.min_subscribers as string | undefined;
  const maxSubscribers = req.query.max_subscribers as string | undefined;
